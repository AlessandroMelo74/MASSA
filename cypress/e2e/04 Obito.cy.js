...
describe('Obito', function() {
    const THREE_SECONDS_IN_ML = 3000
      ...
      it('Obito', function() {
        ...
        //cy.get('#mat-mdc-form-field-label-22 > .ng-tns-c59-16')
        cy.get('#mat-input-9').type('FRANCISCA PEREIRA{enter}')
        cy.get('.mdc-button__label > span').click()
        cy.get('#mat-input-12').type('00401347761')
        //cy.get('#mat-mdc-form-field-label-32 > .ng-tns-c59-22')
        cy.get('#mat-input-13').type('CARLA CRISTINA{enter}')
        cy.Sair()
